...
**a. Detection task** 👇
```
wget https://github.com/ultralytics/assets/releases/download/v8.4.0/yolov5nu.pt
```
...
| :---: | :---: | :---: | :---: |
| **weight** | str | yolov5nu.pt |The original .pt model. |
...
```
python export_ultralytics.py --weight yolov5nu.pt --task 0 --dynamic
```
##
...
```
python ptq.py --onnx yolov5nu.onnx --calib_data images/ --batch_size 32
```
##
...
[primary-gie]
...
config-file=yolov5u/config_infer_dbox_yolov5u.txt
```
Then adjust `config_infer_dbox_yolov5u.txt`.
```
[property]
...
model-engine-file=../../model_zoo/yolov5u/yolov5u-int8.engine
network-mode=1
network-type=0
cluster-mode=2
num-detected-classes=80
parse-bbox-func-name=NvDsInferParseCustomYolov5u_cuda
```
##
